...
function Home() {
  return (
    ...
    <div>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="61xPJJUCZ0L._SX30001_.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="61sjEce24RL._SX3000_.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="61NU2XYj3uL._SX30002_.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
      ...
      <h4 style={{ marginTop: "25px" }}>Deals of the Day</h4>
      ...
      <div className="dod" style={{ marginTop: "25px" }}>
        ...
        <div className="dod_6">
          <Link exact to="/">
            <img src="dod6.jpg" />
            <h4>Premium Mobile Covers</h4>
            <p style={{ color: "green" }}>upto 10% of</p>
            <p class="dod_p">From Ringke</p>
          </Link>
        </div>
        ...
        <div className="dod_7">
          <Link exact to="/">
            ...
            <h4>Speakers</h4>
            <p style={{ color: "green" }}>upto 70% of</p>
            <p class="dod_p">Boat, Intex & more</p>
          </Link>
        </div>
      </div>
      {/* Top Deals-------------------------------------------------------------------------- */}
      ...
      <div className="dod1">
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on1.jpg" />
            <p>Shirts</p>
            <p style={{ color: "green" }}>upto 50% of</p>
            <p class="dod_p">Great Saving</p>
          </Link>
        </div>

        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on2.jpg" />
            <p>Wallets</p>
            <p style={{ color: "green" }}>upto 70% of</p>
            <p class="dod_p">Shop Now</p>
          </Link>
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on3.jpg" />
            <p>Watches</p>
            <p style={{ color: "green" }}>upto 40% of</p>
            <p class="dod_p">Shop Now</p>
          </Link>
        </div>
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on4.jpg" />
            <p>Sling Bags</p>
            <p style={{ color: "green" }}>upto 10% of</p>
            <p class="dod_p">Explore Now</p>
          </Link>
        </div>

        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on5.jpg" />
            <p>T-shirts</p>
            <p style={{ color: "green" }}>upto 50% of</p>
            <p class="dod_p">Discover Now</p>
          </Link>
        </div>

        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on6.jpg" />
            <p>Bags</p>
            <p style={{ color: "green" }}>upto 30% of</p>
            <p class="dod_p">Great Saving</p>
          </Link>
        </div>
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="/top_offers_on/top_offers_on7.jpg" />
            <p>Screen Guards</p>
            <p style={{ color: "green" }}>upto 15% of</p>
            <p class="dod_p">Hurry Dont Miss</p>
          </Link>
        </div>
      </div>
      ...
      <div className="ll dod1" style={{ margin: "40px 0" }}>
        <div className="dod_1">
          <Link exact to="/">
            <img src="mob1.jpg" />
            <h4>Samsung Gallaxy A21s</h4>
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="mob6.jpg" />
            <h4>Tecno Camon 15 Pro</h4>
            <p>4000 mAh Battery</p>
            <span>Now 16999</span>
          </Link>
        ...
        <div className="dod_1">
          <Link exact to="/">
            <img src="mob7.jpg" />
            <h4>Realme X3 Super Zoom</h4>
            <p>4200 mAh Battery</p>
            <span>Now 21999</span>
          </Link>
        </div>
